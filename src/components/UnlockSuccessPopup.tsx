      ...
      {visible && (
        ...
        >
          <motion.div
            ...
            style={{ boxShadow: '0 0 32px 4px #FFA31A55, 0 0 16px 2px #8A00D455' }}
          >
            ...
            <h2 className="text-white font-black text-2xl mb-1 text-center drop-shadow-[0_0_8px_#FFA31A]">Unlocked!</h2>
            ...
            <button
              className="w-full bg-[#FF9900] text-black font-bold py-2 rounded-full shadow-lg hover:shadow-[0_0_8px_#FF9900] transition mb-2 text-lg flex items-center justify-center gap-2"
              onClick={onViewNow}
            >
